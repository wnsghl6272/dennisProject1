...
const Womenwear: React.FC = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const response = await axios.get('https://fakestoreapi.com/products/category/women\'s clothing'); // 여성 의류 카테고리 API 호출
  ...
  return (
    <div className="p-4">
      <h1 className="text-2xl font-bold">Women's Wear Product List</h1>
